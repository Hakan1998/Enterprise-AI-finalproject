...
def convert_to_surprise_format(raw_train_data: pd.DataFrame, raw_test_data: pd.DataFrame) -> Tuple[Dataset, Trainset, pd.Series]:
    ...
    Args:
        raw_train_data (pd.DataFrame): The raw training data containing 'userId', 'movieId', and 'rating' columns.
        raw_test_data (pd.DataFrame): The raw test data containing 'userId', 'movieId', and 'rating' columns.
